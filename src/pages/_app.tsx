  ...
  return (
    <>
      <Head>
        ...
        <meta property="twitter:description" content="I'm {username}"/>
        <meta property="twitter:image" content="/avatar.jpg" />
      </Head>
      <LazyMotion features={domAnimation}>
        <Component {...pageProps} />
      </LazyMotion>
      <Script strategy="lazyOnload" async src={`https://googletagmanager.com/gtag/js?id=${process.env.NEXT_PUBLIC_GA_ID}`} ></Script>
